...
public class PROTOCOLO {
    ...
    public static void cargarProtocolos(DefaultTableModel model){
        ...
        conex.conectar();
        ResultSet rs = conex.CONSULTAR("SELECT p.idprotocolo, p.codigo, p.fechaderegistro, u.nombreusuario, r.numero_remision, e.identrada, cli.nombrecliente, e.lote, t.numeroserie, t.numeroempresa, t.fase, t.marca, t.kvasalida, (tpe,tse, tte) as tension, t.serviciosalida, \n" +
                "d.nodespacho \n" +
                "FROM entrada e \n" +
